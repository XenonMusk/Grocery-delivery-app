...
(0,_admin__WEBPACK_IMPORTED_MODULE_3__.initAdmin)(); //To render order status
...
function updateStatus(order) {
  ...
  var stepCompleted = true; //the first line will be gray
